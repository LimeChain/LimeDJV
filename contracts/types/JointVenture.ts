...
export interface JointVentureInterface extends utils.Interface {
  functions: {
    ...
    "getRevenue(address)": FunctionFragment;
    ...
    "submitProposal(address,string,string,uint256,bytes)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "getRevenue", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "getRevenue", data: BytesLike): Result;
...
export interface JointVenture extends BaseContract {
  ...
  getRevenue(token: string, overrides?: CallOverrides): Promise<BigNumber>;
