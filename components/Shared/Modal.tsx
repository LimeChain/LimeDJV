        ...
        <div className={showHideClassName}>
            <section className="modal-main">
                <div className="close-button">
                    <img className="close-icon" src='/svgs/close.svg' onClick={handleClose}/>
                </div>
                ...
                <div className="button-wrapper">
                    <Button color='purple' size='sm' label="Yes" onClick={onSubmit}>  
                    </Button>
                    <Button color='gray' size='sm' label="Close" onClick={handleClose}>  
                    </Button>
                </div>
            </section>
        </div>
